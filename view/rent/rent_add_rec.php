<?php if( isset( $_GET['edit'] ) && $_GET['edit'] > 0 ){
		...
		if ( is_array( $editrent ) && count( $editrent ) == 1 ) {
			...
			$smdy =date("d/m/Y",strtotime("".$editrent['rec_date'].""));
			$rec_date =$smdy;
			$rec_rent =$editrent['rec_rent'];
			$rentd =$editrent['rentd'];
...
$.ajax( {  
	...
	if (msg === "no") {
		...
		document.getElementById('rentd').value =chkJson['rent_date'];
	}		
	 }
 })
}
...
<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">Rent Date*</label>
                                                ...
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                            <input type="text" class="form-control has-feedback-left" id="rentd" placeholder="Date  D/M/Y" aria-describedby="inputSuccess2Status2" name="rentd" value="<?php echo $rentd; ?>" required/>
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
                      					...
                      					<fieldset>
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                            <input type="text" class="form-control has-feedback-left" id="single_cal2" placeholder="Date  D/M/Y" aria-describedby="inputSuccess2Status2" name="rec_date" value="<?php echo $rec_date; ?>" required/>
                                                            <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                                            <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                                                        </div>
                                                    </div>
...
<input placeholder="Recieved Person Mobile" type="number" class="form-control col-md-7 col-xs-12" required="required" id="rent_del_mob" name="rent_del_mob" data-parsley-id="3686" value="<?php  echo $rent_del_mob; ?>" min="0"/>

...
$(document).ready(function(){
 $.fn.myFunction = function(){ 
      ...
      type: 'post',
      url: 'index.php',
     data: "aj=y&chk=pagination&onlink=lendmoney&getresult="+val+"&where="+where+"&tilldate="+tilldate+"&counter="+counter,
     beforeSend: function(){
			$('#loader-icon').show();
			},
	complete: function(){
...
if (isset($_REQUEST['tilldate'])) {
	...
	$where .= " where nf.fin_end_date ='' AND nf.fin_est<=".$wherefin."";
}else {
                                ...
                                <div class="x_title">
                                    <h2>Results </h2>
										<ul class="nav navbar-right panel_toolbox">
                                      	 <a href="index.php?view=finance&file=dueemi" class="text-primary">Due EMI List</a>
                                    </ul>
												...
												<?php
													...
													if( isset( $all_lend_money ) && is_array( $all_lend_money ) && count( $all_lend_money ) > 0 ){
														...
														/* echo "<pre>";
														 ...
														 die(); */ 
												?>                  
															<tr <?php if ($row['fin_end_date']!=""){ echo 'style="background-color:#AEFFAE"';}else{ echo $refinance['financeDueMonth']>2?'style="background-color:#FF9191"':"";} ?>>

...
ob_start();
error_reporting(0);
setcookie("googtrans", "/en/hi", time() + (86400 * 30), "/", "kalyanetech.com");
...
if (!isset($_SESSION['secure_ddlc'])) {
	...
	if ($_POST['report'] =="expenses") {
		include('view/expansion/report.php');
	}elseif($_POST['report'] =="finance") {
		include('view/finance/report.php');
	}elseif($_POST['report'] =="rent") {
		include('view/rent/report.php');
	}
	die();
}
...
<!--	<link rel="stylesheet" href="css/datepicker.css"/>-->
	...
	.slow .toggle-group { transition: left 25s; -webkit-transition: left 25s; }
	</style>
            ...
            <div class="col-md-3 left_col">
				...
				<div id="google_translate_element"></div>
                    ...
                    <div class="profile">
						...
						<?php if ($_SESSION['secure_ddlc'] == 'admin') { ?><img src="userphoto/admin.jpg" alt="..." class="img-circle profile_img"/><?php }else { ?><?php if (isset($_SESSION['secure_ddlc_user'])) { ?><img src="userphoto/<?php echo $_SESSION['secure_user_id'].".jpg";?>" alt="..." class="img-circle profile_img"/><?php }?><?php } ?>
                            
                        </div>
                        <div class="profile_info">
                            <span>Welcome,</span>
                            <?php if ($_SESSION['secure_ddlc'] == 'admin') { ?><h2>Admin</h2><?php }else { ?><h2><?php if (isset($_SESSION['secure_ddlc_user'])) {echo strtoupper($_SESSION['secure_ddlc_user']);}?></h2><?php } ?>
                        </div>
                    </div>
                    <!-- /menu prile quick info -->
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="glyphicon glyphicon-user"></i>User<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none"><?php if (isset($_SESSION['user_add'])) {
											echo $_SESSION['user_add']>0 ? '<li><a href="index.php?view=user&file=add">Add User</a></li>':'<li><a href="#" class ="largeWarningBasic">Add User</a></li>';
										}else {
										?>
										<li><a href="index.php?view=user&file=add">Add User</a>
                                        </li>
									<?php
										}
									?>
									<?php if (isset($_SESSION['user_list'])) {
											echo $_SESSION['user_list']>0 ? '<li><a href="index.php?view=user">See User</a></li>':'<li><a href="#" class ="largeWarningBasic">See User</a></li>';
										}else {
										?>
										<li><a href="index.php?view=user">See User</a>
                                        </li>
									<?php
										}
									?>
								...
								<li><a><i class="glyphicon glyphicon-registration-mark"></i>Rent<span class="fa fa-chevron-down"></span></span></a>
                                    ...
                                    <?php if (isset($_SESSION['rent_list'])) {
										...
										?>
										<li><a href="index.php?view=rent&file=rent_rec">Rent Recieved</a></li>
										<?php
										}
									?>
                                        
										<?php if (isset($_SESSION['due_rent_list'])) {
											echo $_SESSION['due_rent_list']>0 ? '<li><a href="index.php?view=rent&file=duerent">Due Rent List</a></li>':'<li><a href="#" class ="largeWarningBasic">Due Rent List</a></li>';
										}else {
										?>
										<li><a href="index.php?view=rent&file=duerent">Due Rent List</a></li>
                           ...
                           <li>
						   	   <a><i class="glyphicon glyphicon-plus"></i>Finance<span class="fa fa-chevron-down"></span></a>
									...
									?>
                                        <?php if (isset($_SESSION['reml'])) {
											echo $_SESSION['reml']>0 ? '<li><a href="index.php?view=finance&file=received_tmpl">Received EMI Money List</a></li>':'<li><a href="#" class ="largeWarningBasic">Received EMI Money List</a></li>';
										}else {
										?>
										<li><a href="index.php?view=finance&file=received_tmpl">Received EMI Money List</a></li>
									...
									?>
										 ...
										 <?php if (isset($_SESSION['due_emi_list'])) {
											echo $_SESSION['due_emi_list']>0 ? '<li><a href="index.php?view=finance&file=dueemi">Due EMI List</a></li>':'<li><a href="#" class ="largeWarningBasic">Due EMI List</a></li>';
										}else {
										?>
										<li><a href="index.php?view=finance&file=dueemi">Due EMI List</a></li>
								...
								<li>
								   ...
								   <?php if (isset($_SESSION['exp_add'])) {
											echo $_SESSION['exp_add']>0 ? '<li><a href="index.php?view=expansion&file=add">Add Expenses</a></li>':'<li><a href="#" class ="largeWarningBasic">Add Expenses</a></li>';
										}else {
										?>
										<li><a href="index.php?view=expansion&file=add">Add Expenses</a>
                                        </li>
									<?php
										}
									?>
									 <?php if (isset($_SESSION['exp_list'])) {
											echo $_SESSION['exp_list']>0 ? '<li><a href="index.php?view=expansion">See Expenses</a></li>':'<li><a href="#" class ="largeWarningBasic">See Expenses</a></li>';
										}else {
										?>
										<li><a href="index.php?view=expansion">See Expenses</a>
                                        </li>
									<?php
										}
									?>
								...
								<li>
						   	   	   <a><i class="glyphicon glyphicon-download-alt"></i>Money Received<span class="fa fa-chevron-down"></span></a>								<ul class="nav child_menu" style="display: none">
								   <?php if (isset($_SESSION['mrec'])) {
											echo $_SESSION['mrec']>0 ? '<li><a href="index.php?view=mreceive">Money Received</a></li>':'<li><a href="#" class ="largeWarningBasic">Money Received</a></li>';
										}else {
										?>
										<li><a href="index.php?view=mreceive">Money Received</a>
                                        </li>
									<?php
										}
									?>
								...
								<li>
						   	   	   <a><i class="glyphicon glyphicon-indent-right"></i>Cash In Hand<span class="fa fa-chevron-down"></span></a>								<ul class="nav child_menu" style="display: none">
								   <?php if (isset($_SESSION['chand'])) {
											echo $_SESSION['chand']>0 ? '<li><a href="index.php?view=chand">Cash In Hand</a></li>':'<li><a href="#" class ="largeWarningBasic">Cash In Hand</a></li>';
										}else {
										?>
										<li><a href="index.php?view=chand">Cash In Hand</a>
                                        </li>
									<?php
										}
									?>
								...
								<li>
						   	   	   <a href="login.php?act=logout" title="Logout">
							...
							<li>
						   	   	   <a  href="index.php?view=set" title="Settings">

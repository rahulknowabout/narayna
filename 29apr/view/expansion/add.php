...
<?php if (isset( $_GET['edit'] ) && $_GET['edit'] > 0) {
		...
		if (is_array($edit_expansion) && count($edit_expansion) == 1) {
			...
			$otherp =$edit_expansion['otherp'];
			$exp_mob=$edit_expansion['exp_mob'];
		}
}else {
	$exp_id =0;
	$exp_date ="";
...
<script>
	function displayBlock(str) {
		 if (str === "user") {
		 	//alert(str);
		 	document.getElementById("otherb").style.display = "none";
		 	document.getElementById("user").style.display = "block";
		 }else {
		 	//alert(str);
		 	document.getElementById("user").style.display = "none";
			document.getElementById("otherb").style.display = "block";
		 }
	}
</script>
<!--<script>
                                                ...
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                            <input type="text" class="form-control has-feedback-left" id="single_cal2" placeholder="Date  D/M/Y" aria-describedby="inputSuccess2Status2" name="exp_date" value="<?php echo $exp_date; ?>" required/>
...
<div class="form-group">
<label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">Expenses By<span class="required">*</span>
</label>
<div class="col-md-6 col-sm-6 col-xs-12">
<label class="c-input c-radio">
  <input id="radio1" name="radio" type="radio" value="user" onclick="displayBlock(this.value)"<?php echo $exp_user_id != "" ?$exp_user_id > 0 ?"checked='checked'":"":"checked='checked'";?>>
  <span class="c-indicator"></span>
 User
</label>
<label class="c-input c-radio">
  <input id="radio2" name="radio" type="radio" value="other" onclick="displayBlock(this.value)"<?php echo $exp_user_id != "" ?$exp_user_id < 1 ?"checked='checked'":"":"";?>>
  <span class="c-indicator"></span>
  Other
</label>
</div>
</div>
<div class="form-group" id="user" <?php echo $exp_user_id != "" ? $exp_user_id > 0 ?"style='display:block'":"style='display:none'":"";?>>
<label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">User<span class="required">*</span></label>
...
<div class="form-group" id="otherb" <?php echo $exp_user_id != "" ? $exp_user_id < 1 ?"style='display:block'":"style='display:none'":"style='display:none'";?>>

                                <label for="first-name" class="control-label col-md-3 col-sm-3 col-xs-12">Other<span class="required">*</span>

                                </label>

                                <div class="col-md-6 col-sm-6 col-xs-12">

                                    <input placeholder="Other" type="text" class="form-control col-md-7 col-xs-12"  id="otherp" name="otherp" data-parsley-id="3686" value="<?php  echo $otherp; ?>"/>
...
<div class="col-md-6 col-sm-6 col-xs-12">
	<input placeholder="8452361234" type="number" class="form-control col-md-7 col-xs-12" required="required" id="exp_mob" name="exp_mob" data-parsley-id="3686" value="<?php echo $exp_mob; ?>" min="0"/>
</div>
</div>
...
<?php } ?>
<?php if (isset($_REQUEST['exp_user_id']) && $_REQUEST['exp_user_id']>0) { ?>
<input type="hidden" name="exp_user_ids" id="exp_user_ids" value="<?php echo $_REQUEST['exp_user_id']; ?>"/>	
<?php } ?>

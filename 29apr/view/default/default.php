                        ...
                        <div class="x_panel tile fixed_height_320">
                            ...
                            <div class="x_content">
								...
								<?php if (isset($_SESSION['chand'])) {
										...
										?>
										 <a href="index.php?view=chand"><img src ="icons/cash_in_hand.png" width="65%" height="65%"/></a>
                        ...
                        <div class="x_panel tile fixed_height_320">
                            ...
                            <div class="x_content">
								...
								<?php if (isset($_SESSION['mrec'])) {
										...
										?>
										<a href="index.php?view=mreceive"><img src ="icons/money_received.png" width="65%" height="65%"/></a>
									<?php
										}
									?>

...
if ($user_add > 0 && $user_list > 0 && $add_prop > 0 && $list_prop > 0 && $add_renter > 0 && $list_renter > 0 && $lend_money > 0 && $lend_money_list > 0 && $exp_add > 0 && $exp_list > 0 && $rent_add > 0 && $rent_list > 0 && $mrec > 0 && $chand>0 ) {
	$check_all = 1;
}else {
	$check_all = 0;
}

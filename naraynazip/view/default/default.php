                            ...
                            <div class="x_content">
                                ...
                                <div class="widget_summary">
                                    <?php if (isset($_SESSION['lend_money_list'])) {
										...
										?>
										<a href ="index.php?view=finance"><img src ="icons/bank.png" width="65%" height="65%"/></a>									<?php
										}
										?>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="x_content">
                                ...
                                <div class="widget_summary">
                                    <?php if (isset($_SESSION['list_renter'])) {
										...
										?>
										<a href="index.php?view=rent&file=rent_tmpl"><img src ="icons/rent.png" width="65%" height="65%"/></a>
									<?php
										}
									?>
                                    <div class="clearfix"></div>
                                ...
                                <div class="widget_summary">
                                    ...
                                    <div class="w_center w_55">
										...
										<?php if (isset($_SESSION['add_renter'])) {
											echo $_SESSION['add_renter']>0 ? '<a href="index.php?view=rent&file=rent">Rent Property</a>':'<a href="#" class ="largeWarningBasic">Rent Property</a>';
										}else {
										?>
										<a href="index.php?view=rent&file=rent">Rent Property</a>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="x_panel tile fixed_height_320">
                            ...
                            <div class="x_content">
                                ...
                                <h4>Cash Detail</h4>
                                <div class="widget_summary">
                                    <a href="#"><img src ="icons/cash_in_hand.png" width="65%" height="65%"/></a>
                                    <div class="clearfix"></div>
                                </div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="x_panel tile fixed_height_320">
                            ...
                            <div class="x_content">
                                ...
                                <h4>Money Received Detail</h4>
                                <div class="widget_summary">
                                   <a href="#"><img src ="icons/money_received.png" width="65%" height="65%"/></a>
                                    <div class="clearfix"></div>
                                </div>
                        ...
                        <div class="x_panel tile fixed_height_320">
                            ...
                            <div class="x_content">
								...
								<?php if (isset($_SESSION['exp_list'])) {
										...
										?>
										<a href="index.php?view=expansion"><img src ="icons/expenses.png" width="65%" height="65%"/></a>
                        ...
                        <div class="x_panel tile fixed_height_320">
                            ...
                            <div class="x_content">
								...
								<?php if (isset($_SESSION['user_list'])) {
										...
										?>
										<a href="index.php?view=user"><img src ="icons/user.png" width="65%" height="65%"/></a>
									<?php
										}
									?>

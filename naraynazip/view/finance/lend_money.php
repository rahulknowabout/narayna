<?php if (isset( $_GET['edit'] ) && $_GET['edit'] > 0) {
		...
		if (is_array( $edit_fin ) && count( $edit_fin ) == 1) {
			...
			$fin_start_date =$edit_fin['fin_start_date'];
...
<input placeholder="Finance Amount" type="text" class="form-control col-md-7 col-xs-12" required="required" id="finamount" name="finamount" data-parsley-id="3686" value="<?php echo $fin_amount; ?>"/>
                                                ...
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                            <input type="text" class="form-control has-feedback-left" id="single_cal2" placeholder="Start Date  M/D/Y" aria-describedby="inputSuccess2Status2" name="start_date" value="<?php echo $fin_start_date; ?>" required/>
...
<input placeholder="Finance Amount" type="text" class="form-control col-md-7 col-xs-12" required="required" id="fin_irate" name="fin_irate" data-parsley-id="3686" value="<?php echo $fin_irate ==""?$irate:$fin_irate; ?>"/>
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
                      					...
                      					<fieldset>
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                            <input type="text" class="form-control has-feedback-left" id="single_cal1" placeholder="End Date  M/D/Y" aria-describedby="inputSuccess2Status2" name="end_date" value="<?php echo $fin_end_date; ?>" required/>
                                                            <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                                                            <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                                                        </div>
                                                    </div>

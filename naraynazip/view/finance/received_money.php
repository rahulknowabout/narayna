<?php if (isset( $_GET['edit'] ) && $_GET['edit'] > 0) {
		...
		$edit_fin = $ketObj->runquery( "SELECT", "fin_id,fin_cname,fin_caddress,fin_ccity,fin_cmobile", "nar_finance",array(),$where);
...
<input placeholder="Recieved Amount" type="number" class="form-control col-md-7 col-xs-12" required="required" id="fin_rec_amount" name="fin_rec_amount" data-parsley-id="3686" value="<?php  if (isset($_GET['fin_rec_amount']) && $_GET['fin_rec_amount']>0){echo $_GET['fin_rec_amount'];} ?>" min="0"/>
                                                ...
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                            <input type="text" class="form-control has-feedback-left" id="single_cal2" placeholder="Recieved Date  M/D/Y" aria-describedby="inputSuccess2Status2" name="start_date" value="<?php if (isset($_GET['fin_rec_date']) && $_GET['fin_rec_date']!=""){echo $_GET['fin_rec_date'];} ?>" required/>

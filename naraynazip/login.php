...
if ($_POST['un'] == "".$row['username']."" && $_POST['pw'] == "".$row['password']."") {
	...
	$qer = "SELECT uname,upassword,user_add,user_list,add_prop,list_prop,add_renter,list_renter,lend_money,lend_money_list,rent_add,rent_list,exp_add,exp_list FROM nar_user where uname='".$_POST['un']."' AND upassword ='".$_POST['pw']."'limit 1";
